    ...
    <Router>
      <div className="container mt-4">
        ...
        <Routes>
          ...
          <Route path="/" element={<div className="card p-4"><h2 className="card-title">Fitness, Teams, and More!</h2><p className="card-text">Track your progress, join teams, and compete on the leaderboard.</p></div>} />
        </Routes>
      </div>
    </Router>
  );
